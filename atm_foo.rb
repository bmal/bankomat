...
console.generate_menu(title: "MENU GŁÓWNE - jesteś zalogowany witaj #{found_user.name} #{found_user.surname}\n stan twojego konta: found_user.balance",
                              return_states_and_msgs: {cancel_request: "wyloguj"})